      ...
      <section className="container mx-auto bg-white p-5 ">
        ...
        <section className="container mx-auto bg-white p-5">
          ...
          <div className="flex justify-between text-center p-5" id="demo">
            <div className="col-12 col-sm-6 col-lg-4">
              <h4 className="p-2 font-sembold text-purple-500">
				  <img src="https://d33wubrfki0l68.cloudfront.net/8ae959457496f14932ca6872d8270a03c2956237/df151/assets/images/about/simple.svg" width="80px" class="center-block img-responsive b-margin-sm" alt="Simple"/>
                Simple</h4>
              <p className="mb-8 p-2 ">
                Excepteur sint occaecat cupidatat non proident sunt in culpa qui officia deserunt
                mollit anim id est laborum.
            ...
            <div className="col-12 col-sm-6 col-lg-4">
              <h4 className="p-2 font-sembold text-purple-500">
                <img src="https://d33wubrfki0l68.cloudfront.net/e831f78362ec6c6ebc5d4ac602e57d3cfb156bd3/082af/assets/images/about/informative.svg" width="80px" class="center-block img-responsive b-margin-sm" alt="Informative"/>
                Informative
              </h4>
              <p className="mb-8 p-2 ">
                Excepteur sint occaecat cupidatat non proident sunt in culpa qui officia deserunt
      ...
      <section className="background-color: #FFFFFF">
        <div className="container mx-auto px-6 text-center py-20">
          <h2 className="mb-6 text-4xl font-bold text-center text-black">
			...
			<button className="bg-white font-bold rounded-full mt-6 py-4 px-8 shadow-lg uppercase tracking-wider">Download</button>
        </div>
      </section>
